...
export default function StaffOrgs() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="font-heading text-2xl font-bold">Assigned Organisations</h1>
        <p className="text-sm text-muted-foreground">
          {isSuperAdmin
            ? "You're a platform super admin — you can see every customer organisation."
            : "You can only access organisations you've been explicitly assigned to. Ask a super admin to grant access."}
        </p>
      </div>
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="p-8 text-center space-y-2">
              ...
              <p className="text-sm font-medium">No organisations assigned</p>
              <p className="text-xs text-muted-foreground">
                A super admin needs to grant you access to specific organisations.
              </p>
            </div>
          ) : (
